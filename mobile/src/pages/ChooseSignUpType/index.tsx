...
const ChooseSignUpType = () => {
  ...
  function handleNavigateToTruckSignUp(){
    navigation.navigate('TruckForm');
  }

  function handleNavigateToDriverSignUp(){
    navigation.navigate('DriverForm');
  }
  function handleNavigateToCompanySignUp(){
  ...
  return(
    ...
    <View style={styles.container}>
      ...
      <Text style={styles.title}>Escolha o seu tipo de cadastro</Text>
      <RectButton style={styles.button} onPress={handleNavigateToCompanySignUp}>
            <Text style={styles.buttonText}>Empresa</Text>
      </RectButton>
      <RectButton style={styles.button} onPress={handleNavigateToDriverSignUp}>
            <Text style={styles.buttonText}>Motorista</Text>
      </RectButton>
      <RectButton style={styles.button} onPress={handleNavigateToTruckSignUp}>
