...
const OwnerHome = () => {
  ...
  return(
    <View style = {styles.main}>
      <ScrollView style = {styles.container}>
        <TouchableOpacity style={styles.frete} onPress={handleMap}>
          <View style={styles.FreteHeader}>
            <Text style={styles.freteHeaderText}>Caminhão 23</Text>
        ...
        <TouchableOpacity style={styles.frete} onPress={handleMap}>
          <View style={styles.FreteHeader}>
            <Text style={styles.freteHeaderText}>Caminhão 16</Text>
            <Image style={styles.mapMarkerImage} source={require('../../assets/caminhao.jpg')}/> 
          </View>
          <View style={styles.freteDetail}>
        ...
        <TouchableOpacity style={styles.frete} onPress={handleMap}>
          <View style={styles.FreteHeader}>
            <Text style={styles.freteHeaderText}>Caminhão 02</Text>
            <Image style={styles.mapMarkerImage} source={require('../../assets/caminhao.jpg')}/> 
          </View>
          <View style={styles.freteDetail}>
          <Text style={styles.freteDetailText}>Situação: ATIVO</Text>
      ...
      <TouchableOpacity style={styles.footerIcons} onPress={handleNewTruck}>
